...
E-learning page for the nutrition lesson **"Breakfast Boost"** (with Dora). The header brand and document title are both **"NUT2001"** (kept short for mobile headers). Hero subtitle: *"Join Dora for short clips, quick questions, and simple breakfast tips for independent uni life."* Three tabs:
